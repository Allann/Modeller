...
namespace Core
{
    ...
    public static class ConvertEx
    {
        ...
        {
            return value == null ? default(bool) : ChangeType<bool>(value);
        }
        ...
        {
            return value == null ? default(char) : ChangeType<char>(value);
        }
        ...
        {
            return value == null ? default(sbyte) : ChangeType<sbyte>(value);
        }
        ...
        {
            return value == null ? default(byte) : ChangeType<byte>(value);
        }
        ...
        {
            return value == null ? default(short) : ChangeType<short>(value);
        }
        ...
        {
            return value == null ? default(ushort) : ChangeType<ushort>(value);
        }
        ...
        {
            return value == null ? default(int) : ChangeType<int>(value);
        }
        ...
        {
            return value == null ? default(uint) : ChangeType<uint>(value);
        }
        ...
        {
            return value == null ? default(long) : ChangeType<long>(value);
        }
        ...
        {
            return value == null ? default(ulong) : ChangeType<ulong>(value);
        }
        ...
        {
            return value == null ? default(float) : ChangeType<float>(value);
        }
        ...
        {
            return value == null ? default(double) : ChangeType<double>(value);
        }
        ...
        {
            return value == null ? default(decimal) : ChangeType<decimal>(value);
        }
        ...
        {
            return value == null ? default(DateTime) : ChangeType<DateTime>(value);
        }
        ...
        {
            return value == null ? default(string) : ChangeType<string>(value);
        }
        ...
        public static object ChangeType(object value, Type to, IFormatProvider provider = null)
        {
            ...
            var from = value == null ? null : value == DBNull.Value ? null : value.GetType();
        ...
        private static readonly object _emptyValuesLock = new object();
        private static Dictionary<Type, List<object>> _emptyValues = new Dictionary<Type, List<object>>();
        private static readonly object _registeredDefaultEmptyValuesLock = new object();
        private static List<Type> _registeredDefaultEmptyValues = new List<Type>();
        ...
        public static bool IsEmpty(object value)
        {
            ...
            lock (_emptyValuesLock)
            {
                foreach (var emptyVal in _emptyValues[type])
                {
        ...
        public static void RegisterEmptyValue(Type type, object emptyValue)
        {
            ...
            lock (_emptyValuesLock)
            {
                if (!_emptyValues.ContainsKey(type))
                    _emptyValues.Add(type, new List<object>());

                if (!_emptyValues[type].Contains(emptyValue))
                    _emptyValues[type].Add(emptyValue);
            }
        }
        ...
        private static void RegisterDefaultEmptyValues(Type type)
        {
            ...
            lock (_registeredDefaultEmptyValuesLock)
            {
                // check to see if the default values have already been registered. Can only register once.
                if (_registeredDefaultEmptyValues.Contains(type)) return;

                _registeredDefaultEmptyValues.Add(type);
            }
        ...
        public static object GetDefaultEmptyValue(Type type)
        {
            ...
            lock (_emptyValuesLock)
            {
                ...
                if (_emptyValues.ContainsKey(type) && _emptyValues[type].Count > 0)
                    return _emptyValues[type][0];
            }
            ...
            else if (type.IsEnum)
            {
                ...
                return fields.Length > 1 ? fields[1].GetValue(type) : 0;
            }
            else
            {
                object emptyVal;
        ...
        {
            _emptyValues.Clear();
            _registeredDefaultEmptyValues.Clear();
        }
    }
}
