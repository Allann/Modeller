...
{
    internal class CreateViewModel : IGenerator
    {
        private readonly Module _module;
        private readonly Model _model;

        public CreateViewModel(ISettings settings, Module module, Model model)
        {
        ...
        public IOutput Create()
        {
            ...
            sb.AppendLine("{");
            sb.AppendLine($"    public class {_model.Name.Singular.Value}CreateViewModel : ViewModelBase");
            sb.AppendLine("    {");
            ...
            sb.AppendLine("    }");
            sb.AppendLine("}");
            return new File() { Name = _model.Name.Singular.Value + "CreateViewModel.cs", Content = sb.ToString(), CanOverwrite = Settings.SupportRegen };
        }
    }
}