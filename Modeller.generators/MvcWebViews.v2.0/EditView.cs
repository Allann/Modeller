...
{
    internal class EditView : IGenerator
    {
        private readonly Module _module;
        private readonly Model _model;

        public EditView(ISettings settings, Module module, Model model)
        {
        ...
        public IOutput Create()
        {
            ...
            sb.AppendLine($"@model {_model.Name.Singular.Value}EditViewModel");
            sb.AppendLine();
            sb.AppendLine("@{");
            ...
            sb.AppendLine("    <form asp-action=\"Edit\" id=\"formDetail\">");
            sb.AppendLine("        <partial name=\"_EditHeader\" for=\"Page\" />");
            ...
            sb.AppendLine("}");
            return new File { Name = "Edit.cshtml", Content = sb.ToString(), CanOverwrite = Settings.SupportRegen };
        }
    }
}