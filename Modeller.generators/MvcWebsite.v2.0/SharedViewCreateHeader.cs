...
{
    internal class SharedViewCreateHeader : IGenerator
    {
        private readonly Module _module;

        public SharedViewCreateHeader(ISettings settings, Module module)
        {
        ...
        public IOutput Create()
        {
            ...
            sb.AppendLine("            {");
            sb.AppendLine("                <a class=\"btn btn-outline btn-default\" asp-action=\"Index\" id=\"detailForm-BtnCancel\"><i class=\"far fa-times-circle\"></i> Cancel</a>");
            sb.AppendLine("            }");
            sb.AppendLine("            else");
            sb.AppendLine("            {");
